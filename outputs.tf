output "vpc_id_output" {
  ...
  value       = aws_cloudformation_stack.oe_patterns_pixelfed.outputs["VpcIdOutput"]
}

output "vpc_private_subnet1_id_output" {
  description = "The ID of the first private VPC subnet."
  value       = aws_cloudformation_stack.oe_patterns_pixelfed.outputs["VpcPrivateSubnet1IdOutput"]
}

output "vpc_private_subnet2_id_output" {
  description = "The ID of the second private VPC subnet."
  value       = aws_cloudformation_stack.oe_patterns_pixelfed.outputs["VpcPrivateSubnet2IdOutput"]
}

output "vpc_public_subnet1_id_output" {
  description = "The ID of the first public VPC subnet."
  value       = aws_cloudformation_stack.oe_patterns_pixelfed.outputs["VpcPublicSubnet1IdOutput"]
}
...
output "first_use_instructions" {
  ...
  value       = aws_cloudformation_stack.oe_patterns_pixelfed.outputs["FirstUseInstructions"]
}
